...
const IVMODEL_REFERENCE = Dict(
    ...
    "no_exogenous" => Dict(
        :liml => Dict(
            :homoskedastic => (beta = 1.9336876404887946, se = 0.5126952076804047, kappa = 1.1603258035496644),
            :heteroskedastic => (beta = 1.9336876404887946, se = 0.6046915026576617, kappa = 1.1603258035496644),
        ),
        :fuller => Dict(
            :homoskedastic => (beta = 1.8056208909589633, se = 0.4482976607339658, kappa = 1.1076942246022961),
            :heteroskedastic => (beta = 1.8056208909589633, se = 0.5173813149417508, kappa = 1.1076942246022961),
        ),
        :tsls => Dict(
    ...
    "exogenous" => Dict(
        :liml => Dict(
            :homoskedastic => (beta = 1.2965861503223310, se = 0.2964167733383389, kappa = 1.4403639019770107),
            :heteroskedastic => (beta = 1.2965861503223310, se = 0.3116096694709095, kappa = 1.4403639019770107),
        ),
        :fuller => Dict(
            :homoskedastic => (beta = 1.2832402012315129, se = 0.2919925272318660, kappa = 1.3877323230296423),
            :heteroskedastic => (beta = 1.2832402012315129, se = 0.3000843325841815, kappa = 1.3877323230296423),
        ),
        :tsls => Dict(
...
@testset "ivmodel reference fixtures" begin
    ...
    for (vcov_mode, ref_key) in zip((:homoskedastic, :HC0), (:homoskedastic, :heteroskedastic))
